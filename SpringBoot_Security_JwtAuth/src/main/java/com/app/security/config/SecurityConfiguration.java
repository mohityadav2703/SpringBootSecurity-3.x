...
public class SecurityConfiguration {
	...
	/**
	 * this method is used to load the data from the DB table it take our original
	 * password and encrypt them and set them to authProvider and send to the
	 * Authentication manager to validate them.
	 */
	@Bean
	...
	/**
	 * this method is used to validate the user credentials, is given credentials
	 * are match or not
	 * 
	 * @param config
	 * @return
